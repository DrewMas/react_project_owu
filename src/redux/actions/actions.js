import {GET_GENRES, GET_MOVIE_INFO, GET_MOVIES, SET_CURRENT_PAGE, SET_DARK_THEME, SET_LIGHT_THEME} from "./actionTypes";
...
export {get_Movies, get_Movie_Info, get_Genres, setIsDarkTheme, setIsLightTheme, setCurrentPage};
